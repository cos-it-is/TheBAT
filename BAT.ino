...
bool nativeLang, dualLang, stealthMode, ledOn, liveRate, useGraffiti, acceptCoins, acceptNotes, enableWifi, thermalQR, screenQR, printQuotes, printJokes, triggerAp = false, backupReceipt, balanceCheck;
...
String lannE = "English", porE = "Access Point Launched.", resE = "Restart and launch Access Point to Configure", buyE = "BUY", bitE = "BITCOIN", herE = "HERE", insE = "Insert notes/coins", exiE = "Press button to finish", feeE = "Fee", lanE = "Press button to change language", totE = "Total", scaE = "Scan to receive sats.", walletE = "Funding wallet is low, please top-up and restart.";
    ...
    },
    {
      ...
      },
      {
        ...
        },
        {
          ...
          "apply": "text",
          "value": "",
          "placeholder": "Insert notes/coins",
          "style": "width:90%;display:block;color:#484f59"
        },
        {
          "name": "exit",
...
void logo() {
  ...
  String fwRelease = ("Firmware Version: " + String(fwVersion.c_str()));
  String hwRelease = ("Hardware Version: " + String(hwVersion.c_str()));
  printText(fwRelease.c_str(), u8g2_font_helvB18_te, 1, WHITE, false, 10, 430);
  printText(hwRelease.c_str(), u8g2_font_helvB18_te, 1, WHITE, false, 10, 460);
}
